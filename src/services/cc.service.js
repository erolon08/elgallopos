...
// Registra que el cliente pagó (total o parcial) su deuda: resta del saldo,
// reparte lo pagado entre sus ventas a Cta. Cte. pendientes (de la más vieja
// a la más nueva, como se paga una cuenta real) para poder pintarlas de
// rojo/verde, y genera un ingreso en la caja del turno abierto — entra plata
// real al negocio igual que una venta cobrada, con la forma de pago que sea
// (efectivo, transferencia, cheque, tarjeta, QR...).
const registrarPago = db.transaction(({ cliente_id, monto, forma_pago, motivo, usuario_id, terminal }) => {
...
module.exports = { registrarMovimiento, movimientos, registrarPago, listarDeudas };
